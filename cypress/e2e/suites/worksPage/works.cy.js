describe("This is a section about the companies with the user work", () => {
  ...
  it("TC2: Validate the companies with the user work", () => {
    ...
    cy.get(
      ".font-Chakra.font-medium.about_p.text-base.text-center.sm\\:text-left.text-white.mt-8.w-full.p_Mod"
    )
      .invoke("text")
      .should(
        "contain",
        "Estas son algunas de las varias empresas en las cuales trabajé en proyectos y en donde actualmente trabajo."
      );
