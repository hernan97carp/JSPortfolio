describe('This is a section about the projects make it', () => {
	...
	it('TC4: Two clicks and the right one in the left', () => {
		...
		cy.twoClicksRightsOneLeft('Wallet', 'Cotizador de Seguros', 'Admin. de Veterinaria');
		cy.twoClicksRightsOneLeft('Cotizador de Seguros', 'Admin. de Veterinaria', 'CriptoCotizador');
		cy.twoClicksRightsOneLeft('Admin. de Veterinaria', 'CriptoCotizador', 'Clima');
	});

	it('TC5: Two clicks and the left one in the right', () => {
		cy.twoClicksLeftOneRight('CriptoCotizador', 'Admin. de Veterinaria', 'Cotizador de Seguros');
		cy.twoClicksLeftOneRight('Admin. de Veterinaria', 'Cotizador de Seguros', 'Wallet');
		cy.twoClicksLeftOneRight('Cotizador de Seguros', 'Wallet', 'Clima');
		cy.twoClicksLeftOneRight('Wallet', 'Clima', 'CriptoCotizador');
		cy.twoClicksLeftOneRight('Clima', 'CriptoCotizador', 'Admin. de Veterinaria');
	});
